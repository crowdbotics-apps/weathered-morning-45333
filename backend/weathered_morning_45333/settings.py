"""
Django settings for weathered_morning_45333 project.
...
ROOT_URLCONF = 'weathered_morning_45333.urls'
...
WSGI_APPLICATION = 'weathered_morning_45333.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_morning_45333 API",
    "DESCRIPTION": "API documentation for weathered_morning_45333 App",
    "VERSION": "v1",
}
